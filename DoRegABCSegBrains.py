#! /usr/bin/env python
# Prep_data should already generated T1, T2 nrrd
# Script to do tissue segmentation using newly built atlas and ABC
# Rigid body registration is done using BrainsFit
# Warping/BSpline registration is done as part of ABC
# 
#
# Yundi Shi
...
TaregCmd = Template('/Users/WENDY/Develop/Slicer3-3.6-2010-06-10-darwin-x86/Slicer3 --launch /Users/WENDY/Develop/Slicer3-3.6-2010-06-10-darwin-x86/lib/Slicer3/Plugins/BRAINSFit --fixedVolume $tar --movingVolume $sou --outputVolume $deformed --transformType Affine --useCenterOfHeadAlign --xml $record --interpolationMode BSpline --maskProcessingMode ROIAUTO')
TrregCmd = Template('/Users/WENDY/Develop/Slicer3-3.6-2010-06-10-darwin-x86/Slicer3 --launch /Users/WENDY/Develop/Slicer3-3.6-2010-06-10-darwin-x86/lib/Slicer3/Plugins/BRAINSFit --fixedVolume $tar --movingVolume $sou --outputVolume $deformed --transformType Rigid --useCenterOfHeadAlign --xml $record --interpolationMode BSpline --maskProcessingMode ROIAUTO')
